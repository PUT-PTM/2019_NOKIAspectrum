...
//********** Set custom characters in CGRAM **********//

void LCD1602_SetCGRAM()
{
	/*Set CGRAM to 0x40*/
	LCD1602_writeCommand(0x40);

	/*Definition of custom CHARACTERS*/
	uint8_t v1[8] = { 0b00000, 0b00000, 0b00000, 0b00000, 0b00000, 0b00000, 0b00000, 0b11111 };
	uint8_t v2[8] = { 0b00000, 0b00000, 0b00000, 0b00000, 0b00000, 0b00000, 0b11111, 0b11111 };
	uint8_t v3[8] = { 0b00000, 0b00000, 0b00000, 0b00000, 0b00000, 0b11111, 0b11111, 0b11111 };
	uint8_t v4[8] = { 0b00000, 0b00000, 0b00000, 0b00000, 0b11111, 0b11111, 0b11111, 0b11111 };
	uint8_t v5[8] = { 0b00000, 0b00000, 0b00000, 0b11111, 0b11111, 0b11111, 0b11111, 0b11111 };
	uint8_t v6[8] = { 0b00000, 0b00000, 0b11111, 0b11111, 0b11111, 0b11111, 0b11111, 0b11111 };
	uint8_t v7[8] = { 0b00000, 0b11111, 0b11111, 0b11111, 0b11111, 0b11111, 0b11111, 0b11111 };
	uint8_t v8[8] = { 0b11111, 0b11111, 0b11111, 0b11111, 0b11111, 0b11111, 0b11111, 0b11111 };

	/*Load custom character to CGRAM*/
	for(int i=0 ; i<8 ; i++){
		LCD1602_writeData(v1[i]);
	}
	for(int i=0 ; i<8 ; i++){
		LCD1602_writeData(v2[i]);
	}
	for(int i=0 ; i<8 ; i++){
		LCD1602_writeData(v3[i]);
	}
	for(int i=0 ; i<8 ; i++){
		LCD1602_writeData(v4[i]);
	}
	for(int i=0 ; i<8 ; i++){
		LCD1602_writeData(v5[i]);
	}
	for(int i=0 ; i<8 ; i++){
		LCD1602_writeData(v6[i]);
	}
	for(int i=0 ; i<8 ; i++){
		LCD1602_writeData(v7[i]);
	}
	for(int i=0 ; i<8 ; i++){
		LCD1602_writeData(v8[i]);
	}
}

void LCD1602_DisplayTest()
{
	//Print
	LCD1602_writeData(0x00);//v1
	LCD1602_writeData(0x01);//v2
	LCD1602_writeData(0x02);//v3
	LCD1602_writeData(0x03);//v4
	LCD1602_writeData(0x04);//v5
	LCD1602_writeData(0x05);//v6
	LCD1602_writeData(0x06);//v7
	LCD1602_writeData(0x07);//v8
}

void LCD1602_PrintBand(uint8_t receiveUART)
{
	if(receiveUART == 48){
		LCD1602_print(" ");
	}
	else if(receiveUART == 49){
		LCD1602_writeData(0x00);
	}
	else if(receiveUART == 50){
		LCD1602_writeData(0x01);
	}
	else if(receiveUART == 51){
		LCD1602_writeData(0x02);
	}
	else if(receiveUART == 52){
		LCD1602_writeData(0x03);
	}
	else if(receiveUART == 53){
		LCD1602_writeData(0x04);
	}
	else if(receiveUART == 54){
		LCD1602_writeData(0x05);
	}
	else if(receiveUART == 55){
		LCD1602_writeData(0x06);
	}
	else if(receiveUART == 56){
		LCD1602_writeData(0x07);
	}
}
